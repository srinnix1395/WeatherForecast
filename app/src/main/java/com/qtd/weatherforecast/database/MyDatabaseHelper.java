	...
	public void updateAllData(CurrentWeather currentWeather, int idCity, ArrayList<WeatherHour> arrHour, ArrayList<WeatherDay> arrDay) {
		...
		try {
			...
			for (WeatherHour mWeatherHour : arrHour) {
				...
				long resultHour = db.update(DatabaseConstant.TABLE_HOUR, valuesHour, DatabaseConstant.ID_CITY + "=" + idCity + " AND " + DatabaseConstant.ORDER + "=" + i, null);
			...
			for (WeatherDay weatherDay : arrDay) {
				...
				long resultDay = db.update(DatabaseConstant.TABLE_DAY, valuesDay, DatabaseConstant.ID_CITY + "=" + idCity + " AND " + DatabaseConstant.ORDER + "=" + i, null);
