...
public class MyDatabaseHelper extends SQLiteOpenHelper {
	...
	public void updateWeatherDay(WeatherDay weatherDay, int idCity, int order) {
		...
		try {
			...
			long result = db.update(DatabaseConstant.TABLE_DAY, contentValues, DatabaseConstant.ID_CITY + "=" + idCity + " AND " + DatabaseConstant.ORDER + "=" + order, null);
	...
	public void updateWeatherHour(WeatherHour weatherHour, int idCity, int order) {
		...
		try {
			...
			long result = db.update(DatabaseConstant.TABLE_HOUR, contentValues, DatabaseConstant.ID_CITY + "=" + idCity + " AND " + DatabaseConstant.ORDER + "=" + order, null);
